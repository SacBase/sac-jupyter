...
```bash
pip install sac_program_viewer
```
...
```bash
pip uninstall sac_program_viewer
```
...
# Change directory to the sac_program_viewer directory
...
folder is located. Then you can remove the symlink named `sac_program_viewer` within that folder.
